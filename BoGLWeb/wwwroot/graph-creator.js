document.onload = (function () {
    ...
    GraphCreator.prototype.svgMouseUp = function () {
        ...
        if (draggingElement) {
            document.body.style.cursor = "auto";
            var xycoords = d3.mouse(thisGraph.svgG.node()), d = { img: draggingElement, id: thisGraph.idct++, x: xycoords[0], y: xycoords[1], initialDrag: true };
...
export {};
//# sourceMappingURL=graph-creator.js.map